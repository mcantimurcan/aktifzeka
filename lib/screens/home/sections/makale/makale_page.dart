...
class MakalePage extends StatefulWidget {
  const MakalePage({super.key});
  @override
  State<MakalePage> createState() => _MakalePageState();
}

class _MakalePageState extends State<MakalePage> {
  var url = Uri.parse("https://aktifzeka.com/makale-oku/");
